...
(function () {
  ...
  els.forEach(function (el) {
    ...
    if (parent && (parent.classList.contains('work__grid') || parent.classList.contains('events__row') || parent.classList.contains('skills__groups') || parent.classList.contains('cast-row') || parent.classList.contains('featured__list') || parent.classList.contains('skills__badges') || parent.classList.contains('skills__cert-frames'))) {
